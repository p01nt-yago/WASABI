...
?>
	...
	<div class="pickup_wrap">
		<div class="pickup_inner">
			<h2 class="newsCate_title">Top Seminar Picks</h2>
			<?php 
				$args = [
					'post_type' => 'seminar',
					'posts_per_page' => 1,
		...
		<div class="pickup-ranking_inner">
			<h2 class="newsCate_title">Popular Seminar Articles</h2>
			<?php 
				$args = [
					'post_type' => 'seminar',
					'posts_per_page' => 3,
			...
			?>
					<div class="pickup_list">
						<?php 
							while ( $the_query->have_posts() ){
								$the_query->the_post();
								echo '<div class="pickup_ranking_num">No. ' . $rankingNum . '</div>';
								get_template_part('page-templates/news/item');
	...
	?>
			...
			<button id="load-more" data-page="1" data-post-type="seminar">もっと見る</button>
	<?php
		else:
		wp_reset_postdata();
	?>
